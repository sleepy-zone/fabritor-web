...
export default function ClipSetter () {  
  const { globalImage } = useContext(GloablStateContext);
  const { image: object } = globalImage;
  ...
  const startCrop = () => {
    ...
    setImgInfo({
      ...
      left: boundingRect.left + 48, // 420 is panel width
  ...
  return (
    <div>
      <span
        ...
        onClick={startCrop}
      >
        <svg width="20" height="20" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 4V36H44" stroke="#4d4f5a" stroke-width="4" stroke-linecap="square" stroke-linejoin="miter"/><path d="M20 12H36V28" stroke="#4d4f5a" stroke-width="4" stroke-linecap="square" stroke-linejoin="miter"/><path d="M12 12H4" stroke="#4d4f5a" stroke-width="4" stroke-linecap="square"/><path d="M36 44V36" stroke="#4d4f5a" stroke-width="4" stroke-linecap="square"/></svg>
        &nbsp;裁剪
      </span>
